...
class Yoshida4thOrderIntegrator:
    ...
    def step(positions, velocities, GMs, dt):
        ...
        positions, velocities = VelocityVerletIntegrator.step(positions, velocities, GMs, dt * w1)
        positions, velocities = VelocityVerletIntegrator.step(positions, velocities, GMs, dt * w0)
        positions, velocities = VelocityVerletIntegrator.step(positions, velocities, GMs, dt * w1)
