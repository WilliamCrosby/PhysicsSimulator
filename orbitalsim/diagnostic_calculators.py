...
def two_simulation_position_comparison(bodies, steps, integrator1, integrator2, dt1, dt2):
    ...
    _, positions_1, max_energy1, min_energy1, *_ = sim1.simulator(steps,dt1)
    _, positions_2, max_energy2, min_energy2, *_ = sim2.simulator(int(round(steps * dt1/dt2)),dt2)

    return np.linalg.norm(positions_1 - positions_2, axis=1), f"integrator 1 energy fluctuation: {max_energy1 - min_energy1}\n"f"integrator 2 energy fluctuation: {max_energy2 - min_energy2}"
